    ...
    <div className="self-project">
      ...
      <div className="project">
        ...
        <div className="project-detail">
          <Tooltip
            color="warning"
            content="https://trello-ten-alpha.vercel.app/"
          >
            <Link
              color="warning"
              target="_blank"
              href="https://trello-ten-alpha.vercel.app/"
            >
              Demo
            </Link>
          </Tooltip>
      ...
      <div className="git-link">
        <Link
          color="warning"
          href="https://github.com/HuyNguyen3107/F8_Fullstack_Offline_K4"
        >
          https://github.com/HuyNguyen3107/F8_Fullstack_Offline_K4
        </Link>
      </div>
    </div>
  );
